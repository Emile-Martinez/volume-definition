...
public:
	...
	void rotation(std::vector<std::vector<double>> matrix){
		double mem_x = x, mem_y = y, mem_z = z;
		x = matrix[0][0] * mem_x + matrix[0][1] * mem_y + matrix[0][2] * mem_z;
		y = matrix[1][0] * mem_x + matrix[1][1] * mem_y + matrix[1][2] * mem_z;
		z = matrix[2][0] * mem_x + matrix[2][1] * mem_y + matrix[2][2] * mem_z;
	}
};
